...
const mapStyle = {
  ...
  layers: [
    ...
    // Aeroway & POI layers
    {
      ...
      paint: { 'fill-color': defaultPalette.secondary, 'fill-opacity': 0.3 },
    },
    {
      id: 'aeroway-runway',
      type: 'line',
      ...
      paint: { 'line-color': defaultPalette.secondary, 'line-width': ['interpolate', ['linear'], ['zoom'], 10, 0.5, 12, 2, 14, 4] },
    },
    {
      id: 'aerodrome-label',
      type: 'symbol',
      ...
      minzoom: 10,
      layout: { 'text-field': ['concat', '✈ ', ['coalesce', ['get', 'name:en'], ['get', 'name:latin'], ['get', 'name']]], 'text-font': ['Noto Sans Regular'], 'text-size': ['interpolate', ['linear'], ['zoom'], 10, 9, 14, 12], 'text-padding': 5, 'text-anchor': 'top', 'text-offset': [0, 0.5] },
      paint: { 'text-color': defaultPalette.text, 'text-halo-color': defaultPalette.background, 'text-halo-width': 1.5, 'text-halo-blur': 0.5 },
    },
    {
      id: 'spaceport-area',
      type: 'fill',
      ...
      paint: { 'fill-color': defaultPalette.accent || defaultPalette.secondary, 'fill-opacity': 0.3 },
    },
    {
      id: 'spaceport-label',
      type: 'symbol',
    ...
    },
    {
      ...
      'source-layer': 'poi',
      minzoom: 12,
      filter: ['in', ['get', 'class'], ['literal', ['monument', 'museum', 'stadium', 'attraction', 'artwork', 'viewpoint']]],
      paint: { 'circle-radius': 3, 'circle-color': defaultPalette.primary, 'circle-stroke-width': 1, 'circle-stroke-color': defaultPalette.background },
    },
    {
      id: 'poi-label',
      type: 'symbol',
      ...
      minzoom: 13,
      filter: ['in', ['get', 'class'], ['literal', ['monument', 'museum', 'stadium', 'attraction', 'artwork', 'viewpoint']]],
      layout: { 'text-field': ['coalesce', ['get', 'name:en'], ['get', 'name:latin'], ['get', 'name']], 'text-font': ['Noto Sans Regular'], 'text-size': 9, 'text-padding': 5, 'text-anchor': 'top', 'text-offset': [0, 0.8] },
      paint: { 'text-color': defaultPalette.text, 'text-halo-color': defaultPalette.background, 'text-halo-width': 1.5, 'text-halo-blur': 0.5, 'text-opacity': 0.8 },
    },
  ],
};
